...
(define a_struct (make-a_struct_t "sss" "bbb"))
(printf "1. s: ~a, b: ~a~%" (a_struct_t-s a_struct) (a_struct_t-s a_struct))

(a_struct_t-s-set! a_struct "sss+++")
(a_struct_t-b-set! a_struct "bbb+++")
(printf "2. s: ~a, b: ~a~%" (a_struct_t-s a_struct) (a_struct_t-s a_struct))
